...
pub = rospy.Publisher('taskReport_0', Int16, queue_size=10)
...
if __name__ == "__main__":
    ...
    rospy.init_node('tb3_0_movement')

    rospy.Subscriber("taskAssign_0", String, doTaskCallback)

    print('tb3_0_movement is listening!')
